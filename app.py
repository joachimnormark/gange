...
<style>
  ...
  .corner     {{ fill:#22228c; stroke:white; stroke-width:1; cursor:pointer; }}
  ...
  .tick       {{ stroke:#22228c; stroke-width:3; pointer-events:none; }}
</style>
</head>
<body>
<div id="wrap">
...
const TICK_HALF  = 3;   // 9 px tick / 2  (= 3 × blå stroke-width 3)
